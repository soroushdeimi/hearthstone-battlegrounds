...
> در قلبِ ماو، جایی که زمان معنا ندارد، ماشینی عظیم وجود دارد که جریانِ ارواح را کنترل می‌کند. شما دیگر یک سرباز نیستید؛ شما معمارِ این ماشین هستید.
...
**هدف:** طراحی و پیاده‌سازی یک سرور **Multi-threaded** یا **Asynchronous** که بتواند یک لابی ۴ نفره را مدیریت کند، همگام‌سازی (**Synchronization**) انجام دهد و قوانین بازی را اعمال کند.
...
فرض کنید تو کل بازی فقط یه دونه کارت **"Mama Bear"** توی استخر (**Pool**) باقی مونده.
